...
def get_bounding_box(meta):
    ...
    """
    boundingBox = meta['topsStack.boundingBox']
    lat1 = float(boundingBox.split(' ')[0])
    lat0 = float(boundingBox.split(' ')[1])
    lon0 = float(boundingBox.split(' ')[2])
    lon1 = float(boundingBox.split(' ')[3])
