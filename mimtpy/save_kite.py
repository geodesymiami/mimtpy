...
EXAMPLE = """example:
  ...
  save_kite.py geo_20171117_20200205.unw -g ./inputs/geometryRadar.h5 -o geo_20171117_20200205_kite
  save_kite.py velocity_20141025_20200420.h5 -g ./inputs/geometryRadar.h5 -o velocity_kite 
