...
EXAMPLE = """example:
    ...
    process_psgrn+pscmp_datfiles.py $MODELOUT/pscmp/Bogd/model4/ --direction U --date coseis.dat
...
def create_parser():
    parser = argparse.ArgumentParser(description='Generate NS/EW/UP directions *.tiff and *.json files based on psgrn/pscmp *.dat files',
