...
c
      real*8 k
      complex*16 clahs,cmuhs,yhs(8,4)
c
c     work space
c
      integer*4 i,istp,j,l,lup,llw,key
      real*8 h0
      complex*16 wave,wave2,cdet
      complex*16 b(6,4),orth(3,3)
      complex*16 yup(6,3),ylw(6,3),y1(6,3)
      complex*16 c0(6,3),c1(6,3),yup0(6,3),ylw0(6,3)
      complex*16 mat(6,6),mai(6,6),coef(6,6)
c
