...
c
      integer*4 i,j,j0
      real*8 rho2grf
      complex*16 ck,ck2,cz,cx,cgar
      complex*16 cet,cpx,cmx,ca,cb,cka,ckgp,ckgk,ckg
      complex*16 c2cmck,cepj,cetcx,ckg2cka,clan,cmun
      complex*16 dep,dm,ddm2,ddm4,dmdm2
      complex*16 b(6,4),d(6),dm2(4),cm(4),cep(4)
c
      integer*4 i0
      real*8 eps
