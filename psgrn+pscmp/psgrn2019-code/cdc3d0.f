     ...
     *               ux,uy,uz,uxx,uyx,uzx,uxy,uyy,uzy,uxz,uyz,uzz,iret)
      implicit none
      integer*4 iret
      real*8 x,y,z,depth,dip
      complex*16 pot1,pot2,pot3,pot4,alpha,ux,uy,uz
      complex*16 uxx,uyx,uzx,uxy,uyy,uzy,uxz,uyz,uzz
c
c********************************************************************
c*****                                                          *****
...
c
      integer*4 i
      real*8 ddip
      complex*16 xx,yy,zz,dd,pp1,pp2,pp3,pp4,du
      complex*16 aalpha
      complex*16 u(12),dua(12),dub(12),duc(12)
c
      complex*16 dummy(8),r,dumm(15)
...
c===============================================================================
      ...
      implicit none
      complex*16 x,y,d,pp1,pp2,pp3,pp4
      complex*16 u(12)
c
c********************************************************************
...
c
      ...
      complex*16 du(12)
c
      complex*16 alp1,alp2,alp3,alp4,alp5
      complex*16 sd,cd,sdsd,cdcd,sdcd,s2d,c2d
      common /c0/alp1,alp2,alp3,alp4,alp5,sd,cd,sdsd,cdcd,sdcd,s2d,c2d
c
      complex*16 p,q,s,t,xy,x2,y2,d2,r,r2,r3,r5,qr,qrx,a3,a5,b3,c3
      complex*16 uy,vy,wy,uz,vz,wz
...
c===============================================================================
      ...
      implicit none
      complex*16 x,y,d,z,pp1,pp2,pp3,pp4
      complex*16 u(12)
c
c********************************************************************
...
c
      integer*4 i
      complex*16 c,rd,d12,d32,d33,d53,d54,fi1,fi2,fi3,fi4,fi5
      complex*16 fj1,fj2,fj3,fj4,fk1,fk2,fk3
      complex*16 du(12)
c
      complex*16 alp1,alp2,alp3,alp4,alp5
      complex*16 sd,cd,sdsd,cdcd,sdcd,s2d,c2d
...
c
     ...
     *           uy,vy,wy,uz,vz,wz
c
      complex*16 f0,f1,f2,f3,f4,f5,f8,f9
...
c
      integer*4 i
      complex*16 c,q2,r7,a7,b5,b7,d7,c5,c7,qr5,qr7,dr5
      complex*16 du(12)
c
      complex*16 alp1,alp2,alp3,alp4,alp5
      complex*16 sd,cd,sdsd,cdcd,sdcd,s2d,c2d
      common /c0/alp1,alp2,alp3,alp4,alp5,sd,cd,sdsd,cdcd,sdcd,s2d,c2d
c
      complex*16 p,q,s,t,xy,x2,y2,d2,r,r2,r3,r5
      complex*16 qr,qrx,a3,a5,b3,c3,um(6)
      common /c1/p,q,s,t,xy,x2,y2,d2,r,r2,r3,r5,qr,qrx,a3,a5,b3,c3,um
c
      complex*16 f0,f1,f2,f3,f5,f7,f10,f15
...
c
      complex*16 r7
c
      complex*16 dummy(5),sd,cd,dumm(5)
